...
if (mysqli_num_rows($result)>0) {
 ...
 $_SESSION['name'] = $row['Name'];
     echo "<script>window.location='UserHomePage.php';alert('User Login Successfully');</script>";
}

else
{
    echo "<script>window.location='UserLogin.php';alert('Invalid Email Or Password');</script>";
}	
