...
if(isset($_POST['submit']))
{
    ...
    if ($result) {
      echo "<script>window.location='ViewProduct.php';alert('Products Added Successfully');</script>";
     }
    else {

      echo "<script>window.location='AddProduct.php';alert('Invalid Data');</script>";
   }
 }
